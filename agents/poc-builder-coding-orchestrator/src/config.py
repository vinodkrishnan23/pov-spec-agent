...
class Settings:
    ...
    api_agent_url: str = os.getenv("POC_API_AGENT_URL", "")
    api_agent_client_id: str = os.getenv("POC_API_AGENT_CLIENT_ID", "")
    api_agent_client_secret: str = os.getenv("POC_API_AGENT_CLIENT_SECRET", "")
    data_seeding_agent_url: str = os.getenv("POC_DATA_SEEDING_AGENT_URL", "")
    data_seeding_agent_client_id: str = os.getenv(
        "POC_DATA_SEEDING_AGENT_CLIENT_ID", ""
    )
    data_seeding_agent_client_secret: str = os.getenv(
        "POC_DATA_SEEDING_AGENT_CLIENT_SECRET", ""
    )
    frontend_agent_url: str = os.getenv("POC_FRONTEND_AGENT_URL", "")
    frontend_agent_client_id: str = os.getenv("POC_FRONTEND_AGENT_CLIENT_ID", "")
    frontend_agent_client_secret: str = os.getenv(
        "POC_FRONTEND_AGENT_CLIENT_SECRET", ""
    )
